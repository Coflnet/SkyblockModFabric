...
The recent flip HUD shows the latest flip, item icon, price, target, finder, status, and age. Use `/cofl fliphud move` to place it. Use `/cofl fliphud on`, `/cofl fliphud off`, or `/cofl fliphud reset` to manage it.
